...
export function encodeGetSafeAreaInsetsRequest(message: GetSafeAreaInsetsRequest): Uint8Array {
  let bb = popByteBuffer();
  _encodeGetSafeAreaInsetsRequest(message, bb);
  return toUint8Array(bb);
}

function _encodeGetSafeAreaInsetsRequest(message: GetSafeAreaInsetsRequest, bb: ByteBuffer): void {
...
export function decodeGetSafeAreaInsetsRequest(binary: Uint8Array): GetSafeAreaInsetsRequest {
  return _decodeGetSafeAreaInsetsRequest(wrapByteBuffer(binary));
}

function _decodeGetSafeAreaInsetsRequest(bb: ByteBuffer): GetSafeAreaInsetsRequest {
  let message: GetSafeAreaInsetsRequest = {} as any;
...
export function encodeGetSafeAreaInsetsResponse(message: GetSafeAreaInsetsResponse): Uint8Array {
  let bb = popByteBuffer();
  _encodeGetSafeAreaInsetsResponse(message, bb);
  return toUint8Array(bb);
}

function _encodeGetSafeAreaInsetsResponse(message: GetSafeAreaInsetsResponse, bb: ByteBuffer): void {
...
export function decodeGetSafeAreaInsetsResponse(binary: Uint8Array): GetSafeAreaInsetsResponse {
  return _decodeGetSafeAreaInsetsResponse(wrapByteBuffer(binary));
}

function _decodeGetSafeAreaInsetsResponse(bb: ByteBuffer): GetSafeAreaInsetsResponse {
  let message: GetSafeAreaInsetsResponse = {} as any;
